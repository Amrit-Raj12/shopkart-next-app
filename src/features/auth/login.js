...
import googleAuthHandler from "../../utilis/GoogleAuthHandler"
...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    e.preventDefault()
    e.stopPropagation()
    const response = await fetch(`${API_BASE_URL_AUTH}${API_LOGIN_URL}`, {
      method: "POST",
      headers: {
        ...
        <div className=" container mx-auto flex  items-center  justify-center w-full sm:w-4/5">
          <div className="bg-white shadow-lg rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-10">
            ...
            <button
              ...
              className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 hidden items-center w-full mt-10"
            >
              <svg
                width={19}
                height={20}
            ...
            <button
              ...
              role="button"
              className="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 hidden items-center w-full mt-4"
            >
              <svg
                width={24}
                height={24}
